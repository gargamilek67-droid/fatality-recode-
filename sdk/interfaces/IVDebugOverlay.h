...
public:
	...
	{
		reinterpret_cast<void(__stdcall*)()>(make_offset("engine.dll", sig_init_materials))();
		reinterpret_cast<void(__cdecl*)(const Vector&, const QAngle&, const Vector&, const Vector&, Color, IMaterial*, bool)>(make_offset("engine.dll", sig_render_box))(vOrigin, angles, vMins, vMaxs, c, override_material ? override_material : *reinterpret_cast<IMaterial**>(make_offset("engine.dll", sig_vertex_color_ignorez)), false);
	}
	...
	{
		reinterpret_cast<void(__stdcall*)()>(make_offset("engine.dll", sig_init_materials))();
		reinterpret_cast<void(__cdecl*)(const Vector&, const Vector&, const Vector&, Color, IMaterial*)>(make_offset("engine.dll", sig_render_triangle))(p1, p2, p3, c, override_material ? override_material : *reinterpret_cast<IMaterial**>(make_offset("engine.dll", sig_vertex_color_ignorez)));
	}
